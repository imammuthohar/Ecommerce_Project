...
<div class="container">
    <img src=" {{asset('asset/img/img_avatar2.png')}}" alt="" >
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input placeholder="ketik email anda" id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
